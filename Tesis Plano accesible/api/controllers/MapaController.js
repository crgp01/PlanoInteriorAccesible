module.exports = {
    ...
    informacionOficina: function (req, res) {
        ...
        case '29':
            ...
            cargaHoraria = "Aquí se puede solicitar información sobre algún docente.";
        ...
        case '47':
            ...
            break;
        case '49':
            informacionPrincipal = "Área profesores.";
            cargaHoraria = "Aqui está en construcción nuevas oficinas para docentes. Anteriormente era la biblioteca de sistemas.";
